...
module Ahoy
  ...
  self.user_method = lambda do |controller|
    (controller.respond_to?(:current_user, true) && controller.__send__(:current_user)) || (controller.respond_to?(:current_resource_owner, true) && controller.__send__(:current_resource_owner)) || nil
  end
